...
export default {
  ...
  computed: {
    message() {
      return this.token ? `Hello ${localStorage.getItem('username')}. If you want to see the list of favourite movies , click on Movie list.` :
          "You need to login to see the different movies.\n If you do not already have an account, please register.";
    },
  },
  methods: {
    logout() {
